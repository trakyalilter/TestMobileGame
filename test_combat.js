...
function build_zone(zone) {
    ...
    enemy_db[`z${zone}_boss`] = {
        hp: Math.floor(200 * mult) * 8,
        atk: Math.floor(12 * mult) * 3,
        def: Math.floor(3 * mult) * 4,
    ...
    // Test base multiplier to see what feels "right" for beating regular enemies but failing vs boss
...
console.log("=========================================");
console.log("SCENARIO: Zone 4 Unique gear vs Zone 5");
console.log("=========================================");

// 1. Can it beat Z5 Regulars?
run_sim(4, true, 5, false);

// 2. Can it beat Z5 Boss? (It shouldn't)
run_sim(4, true, 5, true);

// 3. Can Z5 Legendary beat Z5 Boss? (It should)
run_sim(5, false, 5, true, 1.20);
