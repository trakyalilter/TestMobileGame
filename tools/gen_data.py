...
MOBILE_MISSION_DESC = {
    ...
    "m015": "In the Shipyard, build 2 Mass Driver Mk.I — the Corvette has two weapon mounts.",
    ...
    "m019": "On the Craft tab, craft 10 Circuit Boards — they use the Tin you just smelted, plus Copper and Silicon.",
    "m019d": "On the Build page, construct a Solar Array — passive energy that keeps generating while you are away.",
    ...
    "m025b": "On the Craft tab, smelt 160 Steel (Basic Steel Smelting) — Shipwright I burns most of it.",
    ...
    "m028": "On the Gather tab, extract Cassiterite, then smelt it into 70 Tin on the Craft tab. Tin is the solder in every Circuit Board.",
    "m029": "In the Shipyard, build the Carbon Fiber Plate armor module.",
    "m029a3": "On the Craft tab, craft 6 Structural Components — the universal building block of heavy industry, and one goes into every Advanced Circuit.",
    "m029b": "On the Craft tab, craft 6 Advanced Circuits — Shipwright II next door spends all 6. Each takes a Structural Component, Tin, Semiconductor, Gold and Silver.",
    ...
    "m032b": "Research 'Beta Colony Charter' on the Research tab to unlock Sector Beta — it consumes the Harbinger cores plus a large Superalloy and Titanium stock.",
    "m033b": "Research 'Gamma Sector Clearance' on the Research tab to unlock Sector Gamma — it consumes the Colossus cores the Sector Beta boss drops.",
    # The Gamma Colossus is the SECTOR BETA boss (the desktop desc said Sector Gamma).
    "m034": "Defeat the Beta Colossus 3 times — its cores are the key to Gamma Sector Clearance.",
}
